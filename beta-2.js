...
document.addEventListener("DOMContentLoaded", function () {
  ...
  >
    <div class="hospital-details">
      ...
      <a
        href="https://maps.google.com/?q=${hyperlink}" 
        target="_blank"
        class="w-inline-block"
      >
        <div class="hospital-address">
          <span class="hospital-name"
            ><strong class="bold-text-2">${sessions[i].name}</strong></span
          >${sessions[i].address}<br />
        </div>
      </a>
  
      <div class="district-pincode">
        ${sessions[i].district_name}, ${sessions[i].pincode}
      </div>
    </div>
    <div
      id="w-node-_863d7cbb-7f8a-bb20-0515-c1363670ad1c-474fb990"
      class="vaccine-details"
    >
      <h3 class="heading-2">AVAILABLE VACCINE</h3>
      <div class="vaccine-name">${sessions[i].vaccine}</div>
      <div class="dose-available">
        <div class="dose-details">
          ...
          <div class="dose-number">${sessions[i].available_capacity_dose1}</div>
        </div>
        <div class="dose-details">
          ...
          <div class="dose-number">${sessions[i].available_capacity_dose2}</div>
        </div>
      </div>
    </div>
    <div
      id="w-node-_863d7cbb-7f8a-bb20-0515-c1363670ad30-474fb990"
      class="fee-details"
    >
      <div class="fee-typeface">Fee Type</div>
      <div class="free-paid">${sessions[i].fee_type}</div>
      <div class="price-details">
        ...
        <div class="price">${sessions[i].fee}</div>
      </div>
    </div>
  </div>
